package com.example.emailscheduler.demo.web;
...
import com.example.emailscheduler.demo.job.EmailJob;
import com.example.emailscheduler.demo.payload.EmailRequest;
import com.example.emailscheduler.demo.payload.EmailResponse;
...
//			log.error("Error while scheduling email: ",se);
	...
	public ResponseEntity<String> getApiTest(){
		return ResponseEntity.ok("Get API Test - ok");
	}
